...
/**
 * TRolePermission generated by hbm2java
 */
public class TRolePermission implements java.io.Serializable {
	...
	public TRolePermission(long roleId, String name, String clazz, String method, Date createTime, Date updateTime, int exist) {
		this.roleId = roleId;
		this.name = name;
		this.clazz = clazz;
		this.method = method;
